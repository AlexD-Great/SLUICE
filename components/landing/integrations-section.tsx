...
const integrations = [
  { name: "Python", category: "requests", glyph: "py" },
  { name: "curl", category: "shell", glyph: "$" },
  { name: "n8n", category: "no-code", glyph: "n8n" },
  { name: "Zapier", category: "no-code", glyph: "zap" },
  { name: "Go", category: "net/http", glyph: "go" },
  { name: "Rust", category: "reqwest", glyph: "rs" },
  { name: "Ruby", category: "net/http", glyph: "rb" },
  { name: "PHP", category: "guzzle", glyph: "php" },
  { name: "Java", category: "HttpClient", glyph: "jv" },
  { name: "C#", category: "HttpClient", glyph: "c#" },
  { name: "Make", category: "no-code", glyph: "mk" },
  { name: "Bash", category: "cron", glyph: ">_" },
];
    ...
    <section id="integrations" ref={sectionRef} className="relative overflow-hidden">
      ...
      <div className="relative z-10 pt-32 lg:pt-40 text-center">
        ...
        <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
          ...
          Any caller.
          <br />
          <span className="text-muted-foreground">Any language.</span>
        </h2>
      ...
      <div className="relative z-10 mt-0 lg:-mt-24 max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-16">
          {integrations.map((integration, index) => (
            ...
            >
              ...
              {/* Caller glyph */}
              <div className={`w-10 h-10 mb-6 flex items-center justify-center font-mono text-sm border transition-colors ${
                hoveredIndex === index
        ...
        <div className={`flex flex-wrap items-center justify-between gap-8 pt-12 border-t border-foreground/10 transition-all duration-1000 delay-500 pb-32 lg:pb-40 ${
          ...
          <div className="flex flex-wrap gap-12">
            {[
              { value: "REST", label: "No SDK to install" },
              { value: "Bearer", label: "API key auth" },
              { value: "JSON", label: "Proofs and receipts" },
            ].map((stat) => (
          ...
          <a href="/docs" className="group inline-flex items-center gap-2 text-sm font-mono text-muted-foreground hover:text-foreground transition-colors">

...
const securityFeatures = [
  {
    icon: Shield,
    title: "Per-key spend caps",
    description: "Every API key carries its own ceiling and rolling daily budget.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Priced before signing",
    description: "Settlements and uploads are simulated on-chain first.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Full audit trail",
    description: "Who asked, what it cost, who approved, which transaction.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Fails closed",
    description: "With no approver configured, nothing can be released.",
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] mb-12 transition-all duration-1000 ${
            ...
            Autonomous,
            <br />
            <span className="text-muted-foreground">not unsupervised.</span>
          </h2>
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Nothing today sits between &ldquo;an agent decides to pay&rdquo; and &ldquo;the payment executes.&rdquo; Sluice is that circuit breaker: priced up front, capped per key, held for a human when it matters.
            </p>
          </div>
        </div>
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8">
                ...
                <span className="block text-muted-foreground mt-2">over-cap payments executed without a human</span>
              </div>
            </div>
